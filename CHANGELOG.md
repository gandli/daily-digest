# [](https://github.com/gandli/daily-digest/compare/v0.2.0...v) (2026-08-30)
# [](https://github.com/gandli/daily-digest/compare/v0.1.0...v) (2026-08-29)
...
* X帖多repo fanout 中断可续跑(成功才置seen) ([#117](https://github.com/gandli/daily-digest/issues/117)) ([5617fcb](https://github.com/gandli/daily-digest/commit/5617fcbae1003cb1aeb81952ce20e0b4bbcf52e9))
...
* **fanout:** X帖多repo用精简卡(标题+GitHub描述+图+链接)——每repo~2子请求全并发9≈18<50, 单请求全出9个; 完整lookupRepo(5-6子请求×9>50铁超)只用于单repo查询; 仍索引/search ([#118](https://github.com/gandli/daily-digest/issues/118)) ([0eb69ee](https://github.com/gandli/daily-digest/commit/0eb69ee6764e2bf4b904ad4cea772c9992b33b6e))
...
* **X帖嵌套文章:** 利用 tweet.article.blocks 全文存档——嵌套文章(x.com/i/article/...)不再只存链接; md+Telegraph含标题+正文; articleToText 提取纯文本 ([#116](https://github.com/gandli/daily-digest/issues/116)) ([1cb174f](https://github.com/gandli/daily-digest/commit/1cb174f1deb3a5541d6bbffec7fb12209a4fa33a))
...
* **预览:** sendPerRepoMessages 降级路径开链接预览 + link_preview_options.url 指定核心链接(ogUrl)——每条消息稳定预览可预览目标(GitHub/repo/官网) ([#115](https://github.com/gandli/daily-digest/issues/115)) ([b1210fd](https://github.com/gandli/daily-digest/commit/b1210fdcdc205fcf5bcc24f00caa52f72ba03053))
# [](https://github.com/gandli/daily-digest/compare/v0.0.1...v) (2026-08-26)
