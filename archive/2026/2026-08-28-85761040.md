# Web Archive · https://hermes-agent.nousresearch.com/docs/user-guide/features/browser#real-profile-browsing-use-your-own-logins

Title: Browser Automation | Hermes Agent

URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/browser

Published Time: Thu, 27 Aug 2026 11:42:07 GMT
...
### Browser Use mode (default)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser#browser-use-mode-default "Direct link to Browser Use mode (default)")
...
`# Add to ~/.hermes/config.yamlbrowser:  backend: "off"`
...
### Real profile browsing (use your own logins)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser#real-profile-browsing-use-your-own-logins "Direct link to Real profile browsing (use your own logins)")
...
*   **Supported browsers:** Chrome, Edge, Brave, Chromium (whichever is your OS default). A non-Chromium default (e.g. Firefox) fails closed with a clear message rather than guessing.
...
### Lightpanda local engine[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser#lightpanda-local-engine "Direct link to Lightpanda local engine")
...
`# Add to ~/.hermes/config.yamlbrowser:  engine: lightpanda`
...
### Local Chromium-family browser via CDP (`/browser connect`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser#local-chromium-family-browser-via-cdp-browser-connect "Direct link to local-chromium-family-browser-via-cdp-browser-connect")
...
`# ~/.hermes/config.yamlbrowser:  snapshot_threshold: 30000`
...
## Headed Mode (Visible Browser Window)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser#headed-mode-visible-browser-window "Direct link to Headed Mode (Visible Browser Window)")
...
`browser:  headed: true  # default: false`
